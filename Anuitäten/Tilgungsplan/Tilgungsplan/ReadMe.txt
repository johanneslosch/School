========================================================================
    KONSOLENANWENDUNG: Tilgungsplan-Projektübersicht
========================================================================

Diese Tilgungsplan-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Tilgungsplan-Anwendung besteht.


Tilgungsplan.vcxproj
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Tilgungsplan.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
